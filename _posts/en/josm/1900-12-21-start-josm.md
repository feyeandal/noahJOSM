...
This section includes tutorial on how to download and install JOSM, use the Java OpenStreetMap editor, change some of the settings, open a sample map and
learn some of the basic operations of the software. After this you should have a good understanding of how
to draw features on JOSM.

Download JOSM
-------------

- If you have a copy of JOSM on a CD or usb flash disk, you can skip
