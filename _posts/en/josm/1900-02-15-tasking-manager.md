...
permalink: /en/josm/tasking-manager/
lang: en
category: josm
...
-  [JOSM](/en/coordination/tasking-manager/#editing-choices)  
...
Projects are frequently referred to by their Project number, e.g., [**#1636 - DOST-Project NOAH (ISAIAH) Structures Map Up**](http://tasks.hotosm.org/project/1636), and in this instance you could search on #1636 to find this project. We will be using this project for our first Tasking Manager exercise.
...
In our project, we will be using the tag **_building=yes_** to tag the features as buildings. If you know more information about a certain building, please add important details such as **building type** (e.g. `building=school`), **address** (`addr:street=Rizal`) and **number of floors** (`building:levels=3`). If the building is an **evacuation shelter**, add the tag evacuation_center=yes. These tags are needed to be added in the **critical infrastructures** for an effective disaster operations and infrastructure assessment.
...
In this project, the changeset comment "**#ProjectNOAH-ISAIAH**" is automatically indicated in the brief comment when you click the Upload button. You may add other comments such as "added a building" and indicate the imagery you used while editing the feature.
You may use Bing, MapBox or Orbview while editing the features.
...
Different options for editing are presented to you as soon as you lock a square. For our objective, we will be using the JOSM editor.

![Editing options][]  

#### Edit with JOSM  
- Start JOSM before using this link and it will automatically load the existing OSM data into JOSM.  
>  1. 'Enable remote control' needs to be ticked - found under **Edit / Preferences / Remote Control**. If this is not enabled, the OSM data from the selected square will not appear on JOSM.
   2. Select the available imagery that you may use such as Bing and MapBox. Click 'Imagery' and select either Bing or MapBox Satellite.
![Imagery][]   
...
[Job description]: /images/coordination/Job_description_test.png
...
[Instructions]: /images/coordination/tasking_manager_image10.png
[Changeset]: /images/coordination/tasking_manager_image11.png
[Imagery]: /images/coordination/tasking_manager_image12.png